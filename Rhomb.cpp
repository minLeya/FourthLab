...
Rhomb::Rhomb() : Quadrangle{ rng::getFloat(200, sizes::windowLength - 50), rng::getFloat(0, sizes::windowWidth - 50), sf::Color(rng::getFloat(0, 255), rng::getFloat(0, 255), rng::getFloat(0, 255)) },
isShown{ false }, m_horizontalDiagonalLength{ rng::getFloat(50, 100) }, m_verticalDiagonalLength{ rng::getFloat(100, 200) }
{
	//isFourPoint = true;
